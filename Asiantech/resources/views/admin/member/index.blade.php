...
<header id="topbar" class="ph10">
    ...
    <div class="topbar-right hidden-xs hidden-sm">
        <a href="/cpanel/member/create" class="btn btn-default btn-sm fw600 ml10">
            <span class="fa fa-plus pr5"></span> New member</a>
    </div>
</header>
<!-- End: Topbar -->
@endsection
            ...
            <div class="panel panel-visible mb40" id="spy1">
                <div class="panel-heading">
                    <div class="panel-title hidden-xs">
                        <span class="glyphicon glyphicon-tasks"></span>List member
                    </div>
                </div>
                        ...
                        <tbody> 
                            @if($list_member)
                                ...
                                <tr>
                                    ...
                                    <td width="18%">
                                        <a class="button btn-alert btn btn-xs" href="/cpanel/member/{{ $member->id }}/update"> Update </a>
                                        <a class="button btn-danger btn btn-xs" href="javascript:;" onclick="showConfirm('/cpanel/member/{{ $member->id }}/delete')"> Delete </a>
                                    </td>
                                </tr>
                                <?php ++$i; ?>
                                @endforeach

...
{{-- Web site Title --}}
@section('title') New post :: @parent @stop
@section('topbar')
<!-- Start: Topbar -->
...
{!! Form::open(array('url' => URL::to('cpanel/post/create'), 'method' => 'post', 'files'=> true, 'class' => 'form-horizontal', 'role' => 'form')) !!}
    <!-- create new order panel -->
    <div class="panel mb50 mt5">
        <div class="panel-heading">
            <span class="panel-title hidden-xs"> Add New Post</span>
                        ...
                        <div class="section row">
                            ...
                            <div class="col-md-6">
                                <label for="firstname" class="field prepend-icon">
                                    {!! Form::text("post_title[".$language->code."]", '', array('class' => 'form-control')) !!}
                            ...
                            <div class="col-md-12 mt5">
                                <label class="field prepend-icon">
                                    {!! Form::textarea("post_descriptions[".$language->code."]", null, array('class' => 'gui-textarea br-light bg-light summernote', 'placeholder' => 'Post Description')) !!}
                                </label>
                            </div>
                            <div class="col-md-12 mt10">
                            ...
                            <div class="col-md-12 mt5">
                                <label class="field prepend-icon">
                                    {!! Form::textarea("post_contents[".$language->code."]", null, array('class' => 'gui-textarea br-light bg-light summernote', 'placeholder' => 'Post contents')) !!}
                                </label>
                            </div>
                        </div>
                    </div>

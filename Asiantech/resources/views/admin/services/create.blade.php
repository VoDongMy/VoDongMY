...
{!! Form::open(array('url' => URL::to('cpanel/service/create'), 'method' => 'post', 'files'=> true, 'class' => 'form-horizontal form-validate2', 'role' => 'form')) !!}
    <!-- create new order panel -->
    <div class="panel mb50 mt5">
        <div class="panel-heading">
            <span class="panel-title hidden-xs"> Add New Service</span>
                        ...
                        <div class="section row">
                            ...
                            <div class="col-md-6">
                                <label for="firstname" class="field">
                                    {!! Form::text("service_name[".$language->code."]", '', array('class' => 'form-control', 'required')) !!}
                                </label>
                            </div>
                            <div class="col-md-12 mt10">
                            ...
                            <div class="col-md-12 mt5">
                                <label class="field">
                                    {!! Form::textarea("description[".$language->code."]", null, array('class' => 'gui-textarea br-light bg-light')) !!}
                                </label>
                            </div>
                            <div class="col-md-12 mt10">
                            ...
                            <div class="col-md-12 mt5">
                                <label class="field">
                                    {!! Form::textarea("content[".$language->code."]", null, array('class' => 'gui-textarea br-light bg-light summernote', 'placeholder' => 'Post contents')) !!}
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="section row mb5">
                            <div class="col-md-12">
                                ...
                                <div class="col-xs-6">
                                    <label for="name1" class="select">
                                        {!! Form::select('service_type', ['1' => 'Web services', '2' => 'Smartphone applications', '3' => 'Enterprise Services', '4' => 'Internal Services']) !!}
                                        <i class="arrow"></i>
                                    </label>
                                </div>
                            </div>                          
                            <div class="col-md-12 mt10">
                                ...
                                <div class="col-md-6">
                                    <label for="firstname" class="field">
                                        {!! Form::text("service_url", '', array('class' => 'form-control')) !!}
                                        <label class="field-icon" for="name2">
                                        </label>
                                    </label>                                
                                </div>
                            ...
                            <div>
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-12">
                                        <label for="firstname" class="field prepend-icon">
                                            {!! Form::text("app_url_ios", '', array('class' => 'form-control')) !!}
                                            <label class="field-icon" for="name2">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-12">
                                        <label for="firstname" class="field prepend-icon">
                                            {!! Form::text("app_url_android", '', array('class' => 'form-control')) !!}
                                            <label class="field-icon" for="name2">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-12">
                                        <label for="firstname" class="field prepend-icon">
                                            {!! Form::text("app_url_windows", '', array('class' => 'form-control')) !!}
                                            <label class="field-icon" for="name2">

...
{{-- Web site Title --}}
@section('title') Update static page :: @parent @stop
@section('topbar')
<!-- Start: Topbar -->
...
{!! Form::open(array('url' => URL::to('cpanel/staticpage/update'), 'method' => 'post', 'files'=> true, 'class' => 'form-horizontal', 'role' => 'form')) !!}
    <!-- create new order panel -->
    <div class="panel mb50 mt5">
        <div class="panel-heading">
            <span class="panel-title hidden-xs"> Update Static Page</span>
        ...
        <div class="panel-body p20 pb10">
            <div class="tab-content pn br-n admin-form">
                @if (count($languages) > 0)
                    ...
                    @foreach ($languages->all() as $language)
                    <?php
                        $info_static_page = $static_page_datas->where('static_page_id', '=', $page_id)
                        ...
                        <div class="section row">
                            ...
                            <div class="col-md-6">
                                <label for="firstname" class="field prepend-icon">
                                    {!! Form::text("page_title[".$language->code."]", $info_static_page->page_title, array('class' => 'form-control')) !!}
                            ...
                            <div class="col-md-12 mt5">
                                <label class="field prepend-icon">
                                    {!! Form::textarea("page_contents[".$language->code."]", $info_static_page->page_contents, array('class' => 'gui-textarea br-light bg-light summernote', 'placeholder' => 'Post contents')) !!}
                                </label>
                            </div>
                        </div>
                    </div>

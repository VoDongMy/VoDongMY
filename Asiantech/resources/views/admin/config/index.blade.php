...
<header id="topbar" class="ph10">
    <div class="topbar-left">
        <ul class="nav nav-list nav-list-topbar pull-left">
            ...
            <li class="active">
                <a href="/cpanel/config">Configuration website</a>
            </li>
        </ul>
    </div>
</header>
...
{!! Form::open(array('url' => URL::to('cpanel/config'), 'method' => 'post', 'files'=> true, 'class' => 'form-horizontal', 'role' => 'form')) !!}
    ...
    <div class="panel mb50 mt5">
        <div class="panel-heading">
            <span class="panel-title hidden-xs"> Configuration website</span>
            <ul class="nav panel-tabs-border panel-tabs">

                <li class="active">
                    <a href="#tab1" data-toggle="tab">Generate config</a>
                </li>
                <li>
                    <a href="#tab2" data-toggle="tab">Email config</a>
                </li>
            </ul>
        </div>
                ...
                <div id="tab1" class="tab-pane active">
                    <div class="tab-block mb25">
                        <ul class="nav tabs-left tabs-border">
                            <li class="active">
                                <a href="#tab14_1" data-toggle="tab">Home page</a>
                            </li>
                            <li>
                                <a href="#tab14_2" data-toggle="tab">Offshore development page</a>
                            </li>
                            <li>
                                <a href="#tab14_3" data-toggle="tab">About page</a>
                            </li>
                            <li>
                                <a href="#tab14_4" data-toggle="tab">Services page</a>
                            </li>
                        </ul>

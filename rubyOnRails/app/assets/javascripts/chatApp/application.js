$(document).ready(function() {
    ...
    $('#message-content .group-user li').remove('.remove');
    ...
    if( liActive != 'undefined')
        $('#slide-out li[data-active = '+liActive+']').addClass('active');
...
function activeNaviSidebar(){
    var liActive = $('main div.main-content').attr('data-active');
    if( liActive != 'undefined'){
        if($('#slide-out li[data-active = '+liActive+']'))
        $('#slide-out li[data-active = '+liActive+']').addClass('active');
    }else{
        $('#slide-out li').removeClass('active')
    }

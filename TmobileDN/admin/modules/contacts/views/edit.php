            ...
            <div class="lang" id="language" style="display: 'block';">
                <table class="form">
                    <tr>
                        ...
                        <td><input type="text" name="vdata[name]" value="<?php echo $rs->name ?>" style="width: 98%;"></td>
                    </tr>
                    <tr>
                        <td class="label" style="width: 150px;">Chức vụ (Chức danh)</td>
                        <td><input type="text" name="vdata[title]" value="<?php echo $rs->title ?>" style="width: 98%;"></td>
                    </tr>
                    <tr>
                        <td class="label" style="width: 150px;">Địa Chỉ</td>
                        <td><input type="text" name="vdata[address]" value="<?php echo $rs->address ?>" style="width: 98%;"></td>
                    </tr>
                    <tr>
                        <td class="label" style="width: 150px;">Số điện thoại</td>
                        <td><input type="text" name="vdata[phone_1]" value="<?php echo $rs->phone_1 ?>" style="width: 30%;"><span> - </span><input type="text" name="vdata[phone_2]" value="<?php echo $rs->phone_2 ?>" style="width: 30%;"></td>
                    </tr>
                    <tr>
                        <td class="label" style="width: 150px;">Email</td>
                        <td><input type="text" name="vdata[email]" value="<?php echo $rs->email ?>" style="width: 98%;"></td>
                    </tr>
                    <tr>
                        <td colspan="2"><textarea style="width:99%;" rows="5" name="vdata[note]"><?php echo $rs->note ?></textarea></td>
                    </tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $("#id").change(function() {
            id = $(this).val();
            $.getJSON(base_url + 'contacts/get_channel/?id=' + id, function(data) {

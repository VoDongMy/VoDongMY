...
<table class="admindata">
    ...
    <tr class="row<?php echo $k ?>">
        ...
        <td><a href="<?php echo site_url('office/edit/' . $rs->id) ?>"><?php echo $rs->website; if ($rs->website == null) echo $rs->email; ?></a></td>
        <td><a href="<?php echo site_url('office/edit/' . $rs->id) ?>"><?php echo $rs->phone_1;if ($rs->phone_2 != 0) echo$rs->phone_2; ?></a></td>
...
<?php echo icon_edit('office/edit/' . $rs->id) ?>
    ...
    <tr class="row<?php echo $k ?>">
        ...
        <td><a href="<?php echo site_url('office/edit/' . $rs->id) ?>"><?php echo $rs1->website; if ($rs1->website == null) echo $rs1->email; ?></a></td>
        <td><a href="<?php echo site_url('office/edit/' . $rs->id) ?>"><?php echo $rs1->phone_1;if ($rs1->phone_2 != 0) echo$rs1->phone_2; ?></a></td>
    ...
    <tr class="row<?= $k ?>">
        <td><?= $rs2->id ?></td>
        <td align="center"><input type="checkbox" name="ar_id[]" value="<?= $rs2->id ?>"></td>
        <td>|___|___<a href="<?= site_url('office/edit/' . $rs2->id) ?>"><?php echo $rs2->title ?></a></td>
        <td><a href="<?php echo site_url('office/edit/' . $rs->id) ?>"><?php echo $rs2->website; if ($rs2->website == null) echo $rs2->email; ?></a></td>
        <td><a href="<?php echo site_url('office/edit/' . $rs->id) ?>"><?php echo $rs2->phone_1;if ($rs2->phone_2 != 0) echo$rs2->phone_2; ?></a></td>

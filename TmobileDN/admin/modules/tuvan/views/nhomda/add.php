...
<input type="hidden" name="vdata[catid]" value="2">
<?foreach($this->language as $lang):?>
<div class="lang" id="language<?=$lang->lang_id?>" style="display: <?=($lang->lang_default == 1)?'block':'none'?>;">
    <table class="form">
        <tr>
            ...
            <td><input type="text" name="vdata[ten][<?=$lang->lang_id?>]" value="<?php echo set_value('vdata[ten]['.$lang->lang_id.']')?>" class="w500"></td>
        </tr>
    </table>
</div>
<?endforeach;?>

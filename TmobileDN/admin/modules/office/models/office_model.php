...
class office_model extends model{
    ...
    function get_num_contacts($id){
        return $this->db->num_rows("SELECT id FROM contacts WHERE id_office = $id");
    }
    
    function get_num_office($id){
        return $this->db->num_rows("SELECT id FROM office WHERE id_office = $id");
    }

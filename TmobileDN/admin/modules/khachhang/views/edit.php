...
<table class="form">
    ...
    <tr>
        ...
        <td><input type="text" name="vdata[link]" value="<?=$rs->link?>" class="w250"> ví dụ: http://phangiahuy.com</td>
    </tr>
</table>
<?
...
<table class="form">
    <tr>
        ...
        <td><input type="text" name="vdata[name][<?=$lang->lang_id?>]" value="<?=$lang->name?>" style="width: 300px;"></td>
    </tr>
    <tr>
        <td class="label">Giới thiệu</td>
        <td><?=vnit_editor($lang->gioithieu,'vdata[gioithieu]['.$lang->lang_id.']','full_'.$lang->lang_id)?></td>
    </tr>
</table>
</div>
<?endforeach;?>

<ul>
    ...
    <li>
        ...
        <ul>
            ...
            <li><a href="<?=site_url('news/ds')?>">Bài viết</a></li>
        </ul>
    </li>
    <li>
    ...
    <li>
        <a href="<?=site_url('sys_language')?>" class="main">
            <img src="<?=base_url()?>templates/icon/language.png" alt="">
    ...
    <li>
        ...
        <ul>
            <li><a href="<?=site_url('filemanager')?>">Hình ảnh</a></li>
            <li><a href="<?=site_url('filemanager/filedata')?>">File</a></li>
            <li><a href="<?=site_url('filemanager/media')?>">Media</a></li>
        </ul>
    </li>
</ul>
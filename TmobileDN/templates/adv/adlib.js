...
function vng_ads_lib() {
    ...
    this.ShowBanerCenterHome = function () {
        var zone_id = 1;
        this._display_zone(zone_id, "home");
               
    };
    
    this.ShowBanerRightHome = function () {
        var zone_id = 2;
        this._display_zone(zone_id, "home");       
    };
    
    /***********ADV Product *********/
    this._display_zone_product = function(zone_id, catid, type) {
        if (!zone_id) {
            return
        }
        var b = base_url+"trueclick/ajs.php";
    ...
    this.ShowProductCat = function(catid){
        this._display_zone_product(1, catid, "product");
    }
    
    this.ShowProductDetail = function(catid){
        this._display_zone_product(2, catid, "product");
    }
    ...
    */
    ...
    this.ShowNewsHome1 = function(){
        this._display_zone_product(1, 0, "newshome");
    }
    this.ShowNewsHome2 = function(){
        this._display_zone_product(2, 0, "newshome");
    }
    this.ShowNewsHome3 = function(){
        this._display_zone_product(3, 0, "newshome");
    }
    /***************
    * News
    */
    this.ShowBanner1 = function(catid){
        this._display_zone_product(1, catid, "news");
    }
    this.ShowBanner2 = function(catid){
        this._display_zone_product(2, catid, "news");
    }
    this.ShowBanner3 = function(catid){
        this._display_zone_product(3, catid, "news");
    }
    this.ShowBanner4 = function(catid){
        this._display_zone_product(4, catid, "news");
    }
    this.ShowBanner5 = function(catid){
        this._display_zone_product(5, catid, "news");
    }
    this.ShowBanner6 = function(catid){
        this._display_zone_product(6, catid, "news");
    }
    
    
}

var vng_ads = new vng_ads_lib;

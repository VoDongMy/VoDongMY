            ...
            <div class="col-xs-12 col-sm-9 no-margin wide sidebar page-main-content">
                <div id="single-product" class="row">
                        ...
                        <div class="product-item-holder size-big single-product-gallery small-gallery">
                            <div id="owl-single-product">
                                ...
                                <div class="single-product-gallery-item" id="slide{{$key}}">
                                    <a data-rel="prettyphoto" href="{{$image->image}}">
                                        {{HTML::image($image->image,null,array('class'=>'img-responsive'))}}
                                    </a>
                            ...
                            <div class="single-product-gallery-thumbs gallery-thumbs">
                                <div id="owl-single-product-thumbnails">
                                    @foreach($product['product_images'] as $key => $image)
                                    <a class="horizontal-thumb {{($key==0) ? 'active' : null }}" data-target="#owl-single-product" data-slide="{{$key}}" href="#slide{{$key}}">
                                        {{HTML::image("lib/images/blank.gif",null,array('width'=>'67','data-echo'=>asset($image->image_small)))}}
                                    </a>
                                    @endforeach
                    ...
                    <div class="no-margin col-xs-12 col-sm-7 body-holder">
                        <div class="body">
                            <div class="star-holder inline"><div class="star" data-score="{{$product['rate']}}"></div></div>
                        ...
                        <div class="tab-holder">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="additional-info">
                                    {{$product['product_infomations']['value']}}
                                    <div class="meta-row">
                                        <div class="inline">
                                            <label>SKU:</label>
                                            <span>54687621</span>
                                    ...
                                    <div class="comments">
                                        <div class="comment-item">
                                            <div class="row no-margin">
                                                <div class="col-lg-1 col-xs-12 col-sm-2 no-margin">
                                                    <div class="avatar">
                                                        {{HTML::image('lib/images/default-avatar.jpg','avatar')}}
                                                    </div><!-- /.avatar -->
                                                </div><!-- /.col -->
                                        ...
                                        <div class="comment-item">
                                            <div class="row no-margin">
                                                <div class="col-lg-1 col-xs-12 col-sm-2 no-margin">
                                                    <div class="avatar">
                                                        <img alt="avatar" src="../lib/images/default-avatar.jpg">
                                                    </div><!-- /.avatar -->
                                                </div><!-- /.col -->
    			            ...
    			            <div id="owl-recently-viewed-2" class="owl-carousel product-grid-holder">
    				            ...
    				            <div class="no-margin carousel-item product-item-holder size-medium hover">
    					            <div class="product-item">
                                        ...
                                        <div class="image">
                                            {{HTML::image('lib/images/products/product-11.jpg')}}
                                        </div>
                                        <div class="body">
                                            <div class="title">

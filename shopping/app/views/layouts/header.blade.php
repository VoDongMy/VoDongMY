...
<header>
    <div class="container no-padding">
        <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
            ...
            <div class="logo">
                <a href="{{URL::to('/')}}">
                    <!--<img alt="logo" src="lib/images/logo.svg" width="233" height="54"/>-->
                    <!--<object id="sp" type="image/svg+xml" data="lib/images/logo.svg" width="233" height="54"></object>-->
            ...
            <div class="search-area">
                <form>
                    <div class="control-group">
                        <input class="search-field" placeholder="{{__('Search for item')}}" />
                        <ul class="categories-filter animate-dropdown">
                            <li class="dropdown">
                                <a class="dropdown-toggle"  data-toggle="dropdown" href="category-grid.html">{{__('all categories')}}</a>
                                <ul class="dropdown-menu" role="menu" >
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="category-grid.html">{{__('laptops')}}</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="category-grid.html">{{__('tv & audio')}}</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="category-grid.html">{{__('gadgets')}}</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="category-grid.html">{{__('cameras')}}</a></li>
                                </ul>
                            </li>
                        </ul>
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 top-cart-row no-margin">
            <div class="top-cart-row-container">
                <div class="wishlist-compare-holder">
                    <div class="wishlist ">
                        <a href="#"><i class="fa fa-heart"></i>{{__('wishlist')}}&nbsp;<span class="value">({{ (Session::has('wishlist') ? Session::get('wishlist') : '0' )}})</span> </a>
                    </div>
                    <div class="compare">
                        <a href="#"><i class="fa fa-exchange"></i>{{__('compare')}}&nbsp;<span class="value">({{ (Session::has('compare') ? Session::get('compare') : '0' )}})</span> </a>
                    </div>
                </div>
                    ...
                    <div class="basket">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <div class="basket-item-count">
                                <span class="count">{{ (Session::has('count_product') ? Session::get('count_product') : '0' )}}</span>
                                {{HTML::image("lib/images/icon-cart.png")}}
                            </div>
                            <div class="total-price-basket">
                                <span class="lbl">{{__('your cart')}}&nbsp;:</span>
                                <span class="total-price">
                                    <span class="value" id="price_cart">{{ (Session::has('price_cart')) ? Session::get('price_cart') : 0 }}</span><sup class="sign">VND</sup>
                                </span>
                            </div>
                        </a>
                    </div><!-- /.basket -->
